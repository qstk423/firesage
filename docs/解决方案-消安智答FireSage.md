...
| 文档版本 | v4.2（2026-09-05：风险置顶 / 相关追问 / 10 源语料口径） |
...
| 拒答与引导区分 | 库外/乱码拒答；问法过宽则引导到可问示例 | 避免「不会就硬拒」 |
| 风险等级置顶 | 按场景给出紧急/高/中/低风险标签 | 隐患轻重一眼可见 |
| 相关追问 | 回答外提供 3–4 条可点击追问 | 降低二次输入成本 |
| 知识图谱 | 分簇总览；点选展开一级、二级关系与支撑条款 | 把「依据」讲清楚 |
| 回答跳转证据链 | 从本次回答进入局部证据子图；点邻居可动态切换中心 | 咨询过程可解释 |
...
| 知识图谱检索 | 已具备 | 约 112 实体、952 关系（含 10 部法规来源） |
...
| 资产 | 内容 |
|------|------|
| 法规来源 | 《消防法》《公安部 61 号令》《高层规定》《责任制办法》；另含《39 号令》《电动车充电/人员密集场所报批稿》《广东省高层建筑消防安全管理规定》 |
| 规模 | 约 524 条款、1675 语义句、112 图谱实体、952 关系 |
| 评测集 | 229 题人工核验（含物业高频口语），含 train / dev / test 划分 |
